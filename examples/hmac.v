...
// not yet supported
// import crypto.md4
// import crypto.sha224
// import crypto.sha384
...
// import crypto.sha512_224
// import crypto.sha512_256
...
fn main() {
	...
	for i, key in keys {
		...
		result = encode(sha256.sum224, sha256.block_size, key, text[i] ).hex()
		...
		result = encode(sha512.sum384, sha512.block_size, key, text[i] ).hex()
